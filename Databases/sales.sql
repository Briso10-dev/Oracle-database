...
drop table orders_detail_history cascade constraints;
drop table orders cascade constraints;
drop table orders_history cascade constraints;
drop table products_manufacturers cascade constraints;
...
CREATE TABLE orders (
        ...
        constraint orders_fk_customer foreign key (id_cus) references customers,
        constraint orders_fk_employee foreign key (id_emp) references employees
);
...
CREATE TABLE products (
        ...
        name varchar2(50),
        des varchar2(100) ,
        sell_price number(6,2) default 0,
        stock int default 0,
        id_cat int default 0,
        constraint products_fk_category foreign key (id_cat) references categories
);
...
CREATE TABLE orders_detail (
        ...
        constraint order_detail_pk primary key(order_num, product_num),
        constraint order_detail_fk_order foreign key (order_num) references orders,
        constraint order_detail_fk_product foreign key (product_num) references products
);
...
CREATE TABLE orders_detail_history(
        order_num int ,
        product_num int ,
        price number(5,2) default 0,
        quantity int default 0,
        constraint order_detail_fk_h_order foreign key (order_num) references orders_history
);


CREATE TABLE manufacturers (
        id_manu int primary key,
        name varchar2(25)  ,
        address varchar2(50)  ,
        city varchar2(30)  ,
        province varchar2(15)  ,
...
CREATE TABLE products_manufacturers (
        product_num int,
        id_manu int,
        wholesale_price number(6,2) ,
        send_days int,
        
        constraint prod_prov_fk_prod foreign key (product_num) references products,
        constraint prod_prov_fk_vend foreign key (id_manu) references manufacturers
...
--Data insertion into categories
...
--Data insertion into orders_detail
...
--Data insertion into orders_history




--Data insertion into orders_detail_history




--Data insertion into manufacturers
...
insert into manufacturers
  VALUES (11, 'Astro Paper products', 'Avda. del Rio 56', 
   'Castroviejo', 'LA RIOJA', '26637', '(941) 555-9876', '(941) 555-9875', 
   NULL, NULL);


-- Data insertion into products_manufacturers


insert into products_manufacturers
  VALUES (1, 4, 804, 6);
insert into products_manufacturers
  VALUES (1, 9, 854.22, 7);
insert into products_manufacturers
